...
public class RobotServiceImpl implements RobotService {
	...
	protected int createAwtKeyEvent(int e) {
		...
		/*
		 * Begin Media Control Keys case NativeKeyEvent.VC_POWER: case
		 * NativeKeyEvent.VC_SLEEP: case NativeKeyEvent.VC_WAKE: case
		 * NativeKeyEvent.VC_MEDIA_PLAY: case NativeKeyEvent.VC_MEDIA_STOP: case
		 * NativeKeyEvent.VC_MEDIA_PREVIOUS: case NativeKeyEvent.VC_MEDIA_NEXT:
		 * case NativeKeyEvent.VC_MEDIA_SELECT: case
		 * NativeKeyEvent.VC_MEDIA_EJECT: case NativeKeyEvent.VC_VOLUME_MUTE:
		 * case NativeKeyEvent.VC_VOLUME_UP: case NativeKeyEvent.VC_VOLUME_DOWN:
		 * case NativeKeyEvent.VC_APP_MAIL: case
		 * NativeKeyEvent.VC_APP_CALCULATOR: case NativeKeyEvent.VC_APP_MUSIC:
		 * case NativeKeyEvent.VC_APP_PICTURES: case
		 * NativeKeyEvent.VC_BROWSER_SEARCH: case
		 * NativeKeyEvent.VC_BROWSER_HOME: case NativeKeyEvent.VC_BROWSER_BACK:
		 * case NativeKeyEvent.VC_BROWSER_FORWARD: case
		 * NativeKeyEvent.VC_BROWSER_STOP: case
		 * NativeKeyEvent.VC_BROWSER_REFRESH: case
		 * NativeKeyEvent.VC_BROWSER_FAVORITES: // End Media Control Keys
		 */
